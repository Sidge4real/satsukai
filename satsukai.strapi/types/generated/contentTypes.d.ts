...
export interface ApiAuthorAuthor extends Schema.CollectionType {
  ...
  attributes: {
    info: Attribute.Component<'author.author', true>;
...
export interface ApiShopShop extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String & Attribute.Required;
    info: Attribute.Text;
    amount_of_items: Attribute.Integer & Attribute.Required;
    ...
    >;
    indoor: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<true>;
    min_temp: Attribute.Decimal & Attribute.Required;
    max_temp: Attribute.Decimal;
    age: Attribute.Integer;
    max_age: Attribute.Integer;
    showroom: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
